...
import useUpdateCredentialsByTutorId from '../hooks/useUpdateCredentialsByTutorId';
import useGetByTutorId from '../hooks/useGetByTutorId';
import { useQueryClient } from '@tanstack/react-query';

const UpdateCredentialsTutorModal = ({ tutorId, isOpen, onClose }) => {
    const { mutate } = useUpdateCredentialsByTutorId();
...
export default UpdateCredentialsTutorModal;
