...
import useUpdateCredentialsByCompanyId from '../hooks/useUpdateCredentialsByCompanyId';
import useGetByCompanyId from '../hooks/useGetByCompanyId';
import { useQueryClient } from '@tanstack/react-query';

const UpdateCredentialsCompanyModal = ({ companyId, isOpen, onClose }) => {
    const { mutate } = useUpdateCredentialsByCompanyId();
    const queryClient = useQueryClient();

    const { data: company, isLoading } = useGetByCompanyId(companyId);
    ...
    if (!isOpen || isLoading || !companyId) return null;
...
export default UpdateCredentialsCompanyModal;
